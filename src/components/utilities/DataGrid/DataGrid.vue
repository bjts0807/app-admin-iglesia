    ...
    <main>
        <div class="row">
            <div class="col-12 d-flex justify-content-between">
                <div class="d-flex justify-content-between">
                    <input class="form-field mb-2" v-model="pagination.search"
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    <label class="mb-2 mx-2 d-block" for="resultPerPage">Mostrar</label>
                    <select name="resultPerPage" id="resultPerPage"
                            v-model="pagination.per_page"
                            @change="perPageChange()"
                            class="form-field  mb-2 mr-2 form-control-solid w-25">
                        <option value="5">5</option>
                        <option value="10">10</option>
                        <option value="15">15</option>
                        <option value="30">30</option>
                    </select>
                    <label class="mb-2 mx-2 d-block" for="resultPerPage">Por Página</label>
                </div>
            </div>
        </div>
    </main>
